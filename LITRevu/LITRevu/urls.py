...
from applicationLITRevu.views import signup_view, add_ticket, edit_ticket, delete_ticket, create_review, add_review, \
    edit_review, delete_review, user_follows, unfollow_user, feed, posts, block_user, unblock_user
